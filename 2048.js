            ...
            if(document.getElementById(nId).innerHTML != "") {
                ...
                if(val == nVal) {
                    if(excludeIds.indexOf(nId) == -1){
                        ...
                        document.getElementById((k+1)+""+j).style.backgroundColor = "#d4dcff";
                        isMoved = true;
            ...
            if(document.getElementById(nId).innerHTML != "") {
                ...
                if(val == nVal) {
                    if(excludeIds.indexOf(nId) == -1){
                        ...
                        document.getElementById(i+""+(k+1)).style.backgroundColor = "#d4dcff";
                        isMoved = true;
...
function getColor(val)
{
    var color = "#ffffff";
    switch(val) {
        case 2:		color = "#a9b0ff"; break;
        case 4:		color = "#7d83ff"; break;
        case 8:		color = "#6A71D1"; break;
        case 16:	color = "#3f81ff"; break;
        case 32:	color = "#2b89da"; break;
        case 64:	color = "#0C88BD"; break;
        case 128:	color = "#0dbfea"; break;
        case 256:	color = "#5391ef"; break;
        case 512:	color = "#A76DE4"; break;
        case 1024:	color = "#9963f3"; break;
        case 2048:	color = "#b542e6"; break;
        default:	color = "#d4dcff";
    }
    return color;
}
